...
main:
    ...
    lea ebx, [ebp-68]
    push dword [stdin] ; trebuie pusa pe stiva adresa lui stdin 
    push 100
    push ebx
...
;64+4BYTES din stringul FLOW
;5mBfM7bMEJiHCTVeMdbexwV7oTXuJfS4iv7WwqxzTQ7dIrqcxCrjAcB6YXXOViN5FLOW